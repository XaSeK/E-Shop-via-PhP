...
if($no_of_user_products==0){
    ?>
    <script>
        window.alert("Tipota sto kalati my guy");
        </script>
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>PLN <?php echo $sum;?>/-</th><th><a href="success.php?id=<?php echo $user_id?>" class="btn btn-primary">Confirm Order</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <footer class="footer">
               <div class="container">
                <center>
                   ...
                   <p>This website is developed by XaSeK</p>
               </center>
               </div>
           </footer>
        </div>
